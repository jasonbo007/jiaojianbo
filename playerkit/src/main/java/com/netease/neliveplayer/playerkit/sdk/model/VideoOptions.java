...
public class VideoOptions {
     ...
     * 是否使用新的解密方式
     * 只适用于点播
     * false，使用旧的接口解密,使用prepareAsyncWithDecryptionToken、prepareAsyncWithDecryptionKey、switchContentUrlWithDecryptionToken、switchContentUrlWithDecryptionKey；
     * true，使用新的接口解密，使用setDataSource(String path,NEDataSourceConfig config)、switchContentUrl(String url, NEDataSourceConfig config)；
     * 默认为true
     */
    public boolean isUseNewDecryptionMethod = true;
